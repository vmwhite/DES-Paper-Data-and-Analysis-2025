...
def gen_matrix(num):
    ...
    l_bounds = [ 2.73, 0.53, 2.95, 0.44, 25934.05, 4.75, 14.25, 285.00, 0.19, 10.32, 16.72, 3.98, 16.28, 3.93, 8.62, 2.86, 9.54, 2.24, 7.10, 0.98, 4.58, 2.09, 7.49, 2.26, 0.0095, 0.2116, 0.0207, 0.78, 0.45, 2.05, 1.40, 4.54, 1.12, 3.12, 1.53, 4.30, 1.04, 1.86, 1.33, 5.98, 2.38]
    u_bounds = [3.02, 0.59, 3.26, 0.48, 46291.35, 15.75, 52.50, 525.00, 0.84, 11.41, 18.47, 4.40, 17.99, 4.35, 9.53, 3.16, 10.55, 2.47, 7.85, 1.08, 5.06, 2.31, 8.27, 2.50, 0.0105, 0.2338, 0.0229, 0.86, 0.50, 2.27, 1.54, 5.02, 1.23, 3.45, 1.69, 4.75, 1.15, 2.05, 1.47, 6.61, 2.63]
