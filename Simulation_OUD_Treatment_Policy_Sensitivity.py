########################################
''' 
Sensitivity for Simulation of Dane County Opioid use Model
last update: 4/1/24
...
def simulation_run(stuff):
    ...
    #initial population in simualtion
    initial_done = False
...
if __name__ == '__main__':
    ...
    params = {}
    ''' For Sensitivity Run '''
    from Appendix_Items.Sensitvity_Analysis.GenerateSensitivityMatrix import gen_matrix
    number_sens = 1024
    ...
    baseline_treat_per = matrix[process][25]
    death_per = float(1-matrix[process][26]) ###!!!!!!!!!!
    # death_per = 0.03540161 #test not from past results
    ...
    params["LNmean_hospservice"] = matrix[process][27]
    params["LNsig_hospservice"] = matrix[process][28]
    params["LNmean_crimeservice"] = matrix[process][29]
    params["LNsig_crimeservice"] = matrix[process][30]
    params["LNmean_treatservice"] = matrix[process][31]
    params["LNsig_treatservice"] = matrix[process][32]
    params["LNmean_crimerel"] = matrix[process][33]
    params["LNsig_crimerel"] = matrix[process][34]
    params["LNmean_treatrel"] = matrix[process][35]
    params["LNsig_treatrel"] = matrix[process][36]
    params["LNmean_hosprel"] = matrix[process][37]
