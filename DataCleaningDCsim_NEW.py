...
# df_DCdeaths = df_DCdeaths.dropna(thresh=3)
...
#CHECK: This is conistent with https://www.dhs.wisconsin.gov/publications/p01690.pdf 2012-2015 death rate per 100,000 is 12.4 (188) 
...
df_arrestsALL = df_arrests[(df_arrests.ArrestDescription == "Drug - Unknown") | (df_arrests.ArrestDescription == "Drug Possession - Opium/Cocaine") | (df_arrests.ArrestDescription == "Drug Possession - Synthetic") | (df_arrests.ArrestDescription == "Drug Sale - Opium/Cocaine") | (df_arrests.ArrestDescription == "Drug Sale - Synthetic" ) ]
...
df_arrestsALL = pd.concat([df_arrests,df_arrestsALL])
...
df_Yarrests = df_arrestsALL.groupby('ArrestYear')['ArrestCount'].sum()
...
df_treat = df_treat[(df_treat.Year != 2018)]
#add together County-Authorized Treatment individuals and  Medicaid Treatment individuals
df_treat = df_treat.groupby('Year')['Total Individuals'].sum()
...
#line_graph(df_treat["Total Individuals"], df_treat["Year"], "Opioid_Treatment (Number of Treated Individuals)") #plot of data over years
