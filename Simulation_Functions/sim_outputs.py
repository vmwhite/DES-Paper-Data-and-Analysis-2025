import sys
import os
from Simulation_DC_OpioidPolicing.math_functions import *
from Simulation_DC_OpioidPolicing.graph_functions import *
import Simulation_DC_OpioidPolicing.DataCleaningDCsim_NEW as inputs
...
def print_model_outputs(warmup, seeds, starttime, original_stdout, results,params):
    ...
    ci_graph_point(n_runs, start_year, num_years, warmup, dict_mu, dict_max, dict_min, dict_sd(Total_newUsers,num_years), inputs.df_initiation,"Dane County Opioid Initiation estimate (number of people)","Arrival")
